...
namespace Tyuiu.NikolaichukVS.Sprint2.Task2.V18
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (res)
            {
                Console.WriteLine("Точка находится в заштрифованной области");
                

            }
            else
            {
                Console.WriteLine("Точка не находится в заштрифованной области");
            }
